...
are provided in this tab."""
        ...
        st.markdown(
            """A custom model has developed to categorise images to detect hateful content. The model can be used
            for image classification."""
        )
        st.subheader("ii. Meme Classification")
        st.markdown(
            """Classifying memes is a slightly difficult process, since changing either the caption or the text in
            the meme can change the context.
